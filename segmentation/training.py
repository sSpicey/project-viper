...
from .dsets import Luna2dSegmentationDataset, TrainingLuna2dSegmentationDataset, get_Ct
...
class SegmentationTrainingApp:
    ...
    def compute_batch_loss(self, batch_index, batch_tup, batch_size, metrics_g,
    ...
    def log_metrics(self, epoch_index, mode_str, metrics_t):
        ...
        metrics_dict['percent_all/tp'] = \
            sum_a[METRICS_TP_index] / (allLabel_count or 1) * 100
        metrics_dict['percent_all/fn'] = \
            sum_a[METRICS_FN_index] / (allLabel_count or 1) * 100
        metrics_dict['percent_all/fp'] = \
            sum_a[METRICS_FP_index] / (allLabel_count or 1) * 100


        precision = metrics_dict['pr/precision'] = sum_a[METRICS_TP_index] \
            / ((sum_a[METRICS_TP_index] + sum_a[METRICS_FP_index]) or 1)
        recall    = metrics_dict['pr/recall']    = sum_a[METRICS_TP_index] \
            / ((sum_a[METRICS_TP_index] + sum_a[METRICS_FN_index]) or 1)
